...
%>
<jsp:useBean id="message" class="kr.or.bit.dto.TravelReview" scope="page">
...
/* 	boardservice service = boardservice.getInstance();
	...
	if(result.equals("success")){
		msg = "답글을 등록하였습니다.";
		url = "TravelReviewList.TravelReview?cp="+cpage+"&ps="+pagesize;
	}
	else{
		msg = "등록 실패";
		url = "TravelReviewRewrite.TravelReview?tr_num="+message.getTr_num()+"&cp="+cpage+"&ps="+pagesize;
	}
